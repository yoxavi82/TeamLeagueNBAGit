...
public class EquipoUsuarioConexiones implements EquipoUsuarioRepository {
    @Override
    public boolean register(pojos.EquiposUsuarios nuevo) {
        try{
    ...
    @Override
    public ArrayList<pojos.EquiposUsuarios> getAll() {
        ArrayList<pojos.EquiposUsuarios> equipos = new ArrayList<>();
        try{
            Connection connection = Conexion.obtenerConexion();
            if (connection == null) {
            } else {
                ...
                while(rs.next()){
                    pojos.EquiposUsuarios equipo = new pojos.EquiposUsuarios();
    ...
    @Override
    public ArrayList<pojos.EquiposUsuarios> getByUser(String idUser) {
        ArrayList<pojos.EquiposUsuarios> equipos = new ArrayList<>();
        try{
            Connection connection = Conexion.obtenerConexion();
            if (connection == null) {
    ...
    @Override
    public ArrayList<pojos.EquiposUsuarios> getByLiga(String idLiga) {
        ArrayList<pojos.EquiposUsuarios> equipos = new ArrayList<>();
        try{
            Connection connection = Conexion.obtenerConexion();
            if (connection == null) {
    ...
    @Override
    public pojos.EquiposUsuarios getEquipo(String id) {
        pojos.EquiposUsuarios equipo = new pojos.EquiposUsuarios();
        try{
            Connection connection = Conexion.obtenerConexion();
            if (connection == null) {
